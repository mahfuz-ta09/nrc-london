...
export default function ProceedForm() {
    ...
    const onSubmit: SubmitHandler<IFormInput> = async (data) => {
        ...
        if (res?.data?.data?.acknowledged) {
            toast.success("Successful, we will contact you for further information!!")
            reset()
        } else {
        ...
        <div className="form-container">
            <div className="form-wrapper">
                ...
                <form id="studentForm" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        <label className="form-label">Master Certificate</label>
                        <input
                        className="form-input"
                        type="file"
                        accept=".jpg,.jpeg,.pdf,.png"
                    ...
                    <div className="form-group">
                        <label className="form-label">Other Degree Certificate</label>
                        <input
                        className="form-input"
                        type="file"
                        accept=".jpg,.jpeg,.pdf,.png"
                    ...
                    <div className="form-group">
                        <label className="form-label required">English Test Certificate</label>
                        <input
                        className="form-input"
                        type="file"
                        accept=".jpg,.jpeg,.pdf,.png"
                        {...register("proficiencyCirtificate")}
                        />
                    </div>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        Have you ever been refused entry by any country?
                        </label>
                    ...
                    {/* Submit */}
                    <div className="form-section">
                    <button className="form-button" type="submit" disabled={postLoading}>
                        {postLoading ? "Submitting..." : "Proceed"}
                    </button>
                    </div>
                </form>
                </div>

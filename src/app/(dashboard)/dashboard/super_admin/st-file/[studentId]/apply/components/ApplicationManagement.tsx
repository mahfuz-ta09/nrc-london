 ...
 * Replace applicationData with dynamic data from your backend when ready.
 */
const ApplicationManagement: React.FC = () => {
  const [activeTab, setActiveTab] = useState<
    "overview" | "submissions" | "tracking" | "notes" | "history"
  >("overview");
      ...
      <div className="app-wrapper">
          ...
          <div className="tabs">
            {[
              ...
              <button
                ...
                onClick={() =>
                  setActiveTab(
                    tab as "overview" | "submissions" | "tracking" | "notes" | "history"
                  )
                }
        ...
        <div className="tab-content-wrapper">
          ...
          {activeTab === "submissions" && (
            <SubmissionsTab data={applicationData} />
          )}

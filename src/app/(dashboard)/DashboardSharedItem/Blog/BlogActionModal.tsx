...
const BlogActionModal = ({ setModalState, modalState }: ModalProps) => {
    ...
    const onSubmit = async(data: BlogFormData) => {
        try{
            ...
            if(data?.slug)formData.append("slug",(data.slug).toLowerCase().trim().replace(/[^a-z0-9\s-]/g, "").replace(/\s+/g, "-"))
        ...
        <div className={modalState?.isOpen ? 'modal-container openmoda-container' : 'modal-container'}>
            <div className="modal-body">
                ...
                <form className="modal-form" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="input-container">
                        <label>
                            Blog body* (maximum 10 images allowed in the body)
                        </label>
                    </div>
                    ...
                    <div className="input-container">
                        <label>
                            publish this blog or keep as draft
                        </label>
